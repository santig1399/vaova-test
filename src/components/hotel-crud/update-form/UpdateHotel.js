...
const UpdateHotel = ({ initialValues, id, updateHotel, loading }) => {
  const handleSubmit = (values, { resetForm }) => {
    updateHotel({ updatedHotel: values, onAddComplete: resetForm, id });
  };
    ...
    <S.Wrapper>
      ...
      >
        {({ errors, values, setFieldValue }) => (
          <S.Form>
            <S.Headline>Actualizar hotel</S.Headline>
            <S.Group>
              <InputGroup
                id="name"
                name={'name'}
            ...
            <S.Button type="submit" disabled={loading}>
              {!loading ? 'Actualizar hotel' : 'Actualizando hotel...'}
            </S.Button>
          </S.Form>
        )}
      </Formik>
